...
public class AppConfig {
    ...
    public boolean isSimulateRandomPaymentFailures() { return simulateRandomPaymentFailures; }
    public String getDefaultPricingStrategy() { return defaultPricingStrategy; }
    public String getDefaultPaymentProvider() { return defaultPaymentProvider; }
    public boolean isAllowDiscountsForAlcohol() { return allowDiscountsForAlcohol; }

    public void setCurrency(String v) { currency = v; }
    public void setVatPercent(double v) { vatPercent = v; }
    public void setDemoMode(boolean v) { demoMode = v; }
    public void setSimulateRandomPaymentFailures(boolean v) { simulateRandomPaymentFailures = v; }
    public void setDefaultPricingStrategy(String v) { defaultPricingStrategy = v; }
    public void setDefaultPaymentProvider(String v) { defaultPaymentProvider = v; }
    public void setAllowDiscountsForAlcohol(boolean v) { allowDiscountsForAlcohol = v; }
}
