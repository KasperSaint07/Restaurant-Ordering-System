...
public class GeorgianMealFactory implements MealFactory {
    private static final String[] FAST = { "GE_KHACHAPURI", "GE_KUBDRARI"};
    private static final String[] DESS = { "GE_CHURCHKHELA"};
    private static final String[] DRNK = { "GE_KHARCHO", "GE_CHASHUSHULI"};
    private static final String[] HOT = { "GE_GEORGIAN_LEMONADE"};
